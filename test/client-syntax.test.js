...
test('browser scripts parse cleanly', async () => {
  for (const file of ['app.js', 'persistence.js', 'sha256.js', 'protocol.js', 'security.js', 'verification.js', 'connection.js', 'control-policy.js', 'transfer-core.js', 'storage.js', 'sw.js']) {
