...
const SHELL=['/','/style.css','/app.js','/sha256.js','/protocol.js','/security.js','/verification.js','/connection.js','/control-policy.js','/transfer-core.js','/storage.js','/persistence.js','/favicon.svg','/manifest.webmanifest'];
