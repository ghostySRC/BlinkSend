const CACHE='blinksend-shell-v6';
const SHELL=['/','/style.css','/app.js','/locales.js','/locales/es.js','/locales/fr.js','/locales/de.js','/locales/pt.js','/locales/zh.js','/locales/ja.js','/locales/ar.js','/sha256.js','/protocol.js','/security.js','/verification.js','/connection.js','/control-policy.js','/transfer-core.js','/storage.js','/persistence.js','/receive-worker.js','/hash-worker.js','/favicon.svg','/manifest.webmanifest'];
